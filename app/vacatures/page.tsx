          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
                Interesse in werken bij <span className="text-accent-yellow">Riekhoff</span>?
              </h2>
              <p className="text-xl text-gray-300 mb-8">
                Neem contact op voor een vrijblijvend kennismakingsgesprek in Oldenzaal
              </p>
              ...
              <div className="mt-12 pt-12 border-t border-white/10">
                <p className="text-gray-400">
                  Riekhoff Accountants en Adviseurs • Bentheimergraven 11, Oldenzaal
                </p>
              </div>
            </div>
          </div>
